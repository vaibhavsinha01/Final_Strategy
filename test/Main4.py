...
class StrategyName:
    ...
    def Functions(self):
        ...
        self.data['pp'] = (self.data['High'] + self.data['Low'] + self.data['Close']) / 3
        self.data['r1'] = 2 * self.data['pp'] - self.data['Low']
        self.data['r2'] = self.data['pp'] + (self.data['High'] - self.data['Low'])
        self.data['r3'] = self.data['High'] + 2 * (self.data['pp']  - self.data['Low'])
        self.data['s1'] = 2 * self.data['pp']  - self.data['High']
        self.data['s2'] = self.data['pp']  - (self.data['High'] - self.data['Low'])
        self.data['s3'] = self.data['Low'] - 2 * (self.data['High'] - self.data['pp'] )
